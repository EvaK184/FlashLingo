...
# Bulgarian Dictionaries per category
Greetings = [
    ...
    {"bulgarian": "Добре съм. Благодаря. А ти?", "english": "I am fine. Thank you. How about you? (informal)",
     "pronunciation": "do-bre sŭm. bla-go-da-rya. a ti?"},
    {"bulgarian": "Добре съм. Благодаря. А Вие?", "english": "I am fine. Thank you. How about you? (formal)",
     "pronunciation": "do-bre sŭm. bla-go-da-rya. a vie?"}
]

Introducing_yourself = [
    {"bulgarian": "Здравей, казвам се...", "english": "Hello, my name is...",
     "pronunciation": "zdrav-ey, kaz-vam se..."},
    {"bulgarian": "Аз съм от...", "english": "I am from...", "pronunciation": "az sam ot..."},
    {"bulgarian": "Приятно ми е да се запознаем.", "english": "Nice to meet you.",
     "pronunciation": "pri-yat-no mee eh da se za-poz-na-em"},
    ...
    {"bulgarian": "Какво работите?", "english": "What do you do for a living?fo",
     "pronunciation": "kak-vo ra-bo-ti-te?"},
    ...
    {"bulgarian": "Какви са твоите хобита?", "english": "What are your hobbies?in",
     "pronunciation": "kak-vee sa tvo-ye-te ho-bi-ta?"},
    {"bulgarian": "Какви са вашите хобита?", "english": "What are your hobbies?fo",
     "pronunciation": "kak-vee sa va-shee-te ho-bi-ta?"},
...
Telling_the_Time = [
    ...
    {"bulgarian": "една и петнадесет минути", "english": "one fifteen",
     "pronunciation": "ed-na i pet-na-de-set mi-nu-tee"},
    {"bulgarian": "три и тридесет минути", "english": "three thirty", "pronunciation": "tree i tree-de-set mi-nu-tee"},
    {"bulgarian": "пет и четиридесет и пет минути", "english": "five forty-five",
     "pronunciation": "pet i che-tee-ree-de-set mi-nu-tee"},
...
"Numbers":Numbers,
"Days_Months_Seasons":Days_Months_Seasons,
...
for key, value in Categories.items():
    ...
    with open(filename, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        writer.writerows(value)  # Write the data rows
